        ...
        <div className="str-chat__audio__wrapper">
          ...
          <div className="str-chat__audio__image">
            <div className="str-chat__audio__image--overlay">
              {!this.state.playing ? (
                <div onClick={() => this.playAudio()} className="str-chat__audio__image--button">
                ...
                <div onClick={() => this.pauseAudio()} className="str-chat__audio__image--button">
                  <svg width="40" height="40" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                    <path
          ...
          <div className="str-chat__audio__content">
            ...
            <span className="str-chat__audio__content--subtitle">{og.text}</span>
