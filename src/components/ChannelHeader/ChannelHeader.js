...
import { withChatContext, withChannelContext, withTranslationContext } from '../../context';
 ...
 */
const ChannelHeader = ({ openMobileNav, channel, title, live, watcher_count, t }) => (
  <div className="str-chat__header-livestream">
    ...
    {channel.data.image && (
      <Avatar image={channel.data.image} shape="rounded" size={channel.type === 'commerce' ? 60 : 40} />
    )}
    <div className="str-chat__header-livestream-left">
      ...
      {channel.data.subtitle && <p className="str-chat__header-livestream-left--subtitle">{channel.data.subtitle}</p>}
...
export default withChannelContext(withTranslationContext(withChatContext(ChannelHeader)));
