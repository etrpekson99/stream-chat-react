  ...
  render() {
    return (
      <div ref={this.actionsRef} className="str-chat__message-actions">
        <div className="str-chat__message-actions-reactions" onClick={this.props.onClickReact}>
        ...
        <div className="str-chat__message-actions-options" onClick={() => this._openActionBox()}>
