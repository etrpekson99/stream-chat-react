...
class MessageInputFlat extends PureComponent {
  ...
  renderEmojiPicker = () => {
    if (this.props.emojiPickerIsOpen) {
      return (
        <div className="str-chat__input-flat--emojipicker" ref={this.props.emojiPickerRef}>
          <Picker
            native
            emoji="point_up"
  ...
  render() {
    ...
    return (
      <div className={`str-chat__input-flat ${SendButton ? 'str-chat__input-flat--send-button-active' : null}`}>
        <ImageDropzone
          ...
          <div className="str-chat__input-flat-wrapper">
            ...
            <div className="str-chat__input-flat--textarea-wrapper">
              ...
              <span className="str-chat__input-flat-emojiselect" onClick={this.props.openEmojiPicker}>
