...
class MessageInputLarge extends PureComponent {
  ...
  renderEmojiPicker = () => {
    if (this.props.emojiPickerIsOpen) {
      return (
        <div className="str-chat__input--emojipicker" ref={this.props.emojiPickerRef}>
          <Picker
            native
            emoji="point_up"
        ...
        <ImageDropzone
          ...
          <div className="str-chat__input">
            ...
            <div className="str-chat__input--textarea-wrapper">
              ...
              <span className="str-chat__input-emojiselect" onClick={this.props.openEmojiPicker}>
            ...
            <div className="str-chat__input-footer">
              <span
                className={`str-chat__input-footer--count ${
                  !this.props.watcher_count ? 'str-chat__input-footer--count--hidden' : ''
                }`}>
                {t('{{ watcherCount }} online', {
                  watcherCount: this.props.watcher_count,
                })}
              </span>
              <span className="str-chat__input-footer--typing">{this.constructTypingString(this.props.typing)}</span>
            </div>
          </div>
        </ImageDropzone>
      </div>
